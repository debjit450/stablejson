...
export default {
  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        sans: ['Syne', 'Geist', 'Inter', 'system-ui', 'sans-serif'],
        mono: ['JetBrains Mono', 'Space Mono', 'Geist Mono', 'monospace'],
        display: ['Syne', 'Geist', 'Inter', 'system-ui', 'sans-serif'],
        body: ['Inter', 'system-ui', 'sans-serif'],
        code: ['JetBrains Mono', 'Geist Mono', 'monospace'],
      },
      colors: {
